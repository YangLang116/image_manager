package com.xtu.plugin.res.manager.advice;
...
import com.xtu.plugin.res.manager.network.NetworkManager;
import com.xtu.plugin.res.manager.utils.CloseUtils;
import com.xtu.plugin.res.manager.utils.ToastUtils;
import com.xtu.plugin.res.manager.utils.VersionUtils;
import okhttp3.Call;
...
public class AdviceManager {
    ...
    private static final String APP_KEY = "Image Manager";
