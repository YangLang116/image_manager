...
import com.xtu.plugin.res.manager.menu.ResMenu;
import com.xtu.plugin.res.manager.utils.CollectionUtils;
import com.xtu.plugin.res.manager.utils.FileUtils;
import com.xtu.plugin.res.manager.utils.PluginUtils;
...
public class ResManagerRootPanel extends JPanel implements ListCellRenderer<File>, ResManagerListener {
    ...
    public void localeRes(@NotNull String filePath) {
